...
class EnrolledStudentCard extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }

  _gotoEnrolledStudentScreen = () => {
    this.props?.navigation.navigate('EnrolledStudent', {
  ...
  render() {
    return (
      <TouchableOpacity
        style={{ flex: 1 }}
        onPress={this._gotoEnrolledStudentScreen}>
...
export default withNavigation(EnrolledStudentCard);
