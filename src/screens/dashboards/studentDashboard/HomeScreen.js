...
const { TopRatedTutorCard, PopularCourseCard } = studentComponents;
    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView>
          ...
          />
          <PTitle style={styles.title}>Top Rated Tutors</PTitle>
          <FlatList
            horizontal
            data={topRatedTutors}
          ...
          />
          <PTitle style={styles.title}>Popular Courses</PTitle>
          <FlatList
            horizontal
            data={popCourses}
            keyExtractor={(item, index) => index.toString()}
            renderItem={({ item }) => (
              <PopularCourseCard description={item.desc} />
            )}
          />
        </ScrollView>
      </View>
